...
class CostDerivatives:
    '''
    Class for computing just cost derivatives with support for varying reference state and action
    '''
...
class ModelAutoDiff:
    '''
    Class for computing cost derivatives and linearizes dynamics 
    '''
    def __init__(self, discrete_dynamics, cost_stage, cost_final, xref, uref, n_x, n_u):
        self.x_sym = np.array(
